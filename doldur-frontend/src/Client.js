...
export class Client {
    constructor() {
        // S3 urls
        this.coursesUrl =
            "https://s3.amazonaws.com/cdn.robotdegilim.xyz/data.json";
        this.lastUpdatedUrl =
            "https://s3.amazonaws.com/cdn.robotdegilim.xyz/lastUpdated.json";
        this.mustUrl =
            "https://s3.amazonaws.com/cdn.robotdegilim.xyz/musts.json";
        this.departmentsUrl =
            ...
            sectionNumbers.map((sn) => {
                ...
                s["t"].map((t) => {
                    sectionToPush.lectureTimes.push({
                        ...
                        day: t["d"],
                        startHour: parseInt(
                            t["s"].slice(0, t["s"].search(":"))
                        ),
                        startMin: parseInt(
                            t["s"].slice(t["s"].search(":") + 1)
                        ),
