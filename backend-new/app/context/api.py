...
def load_context() -> None:
    ...
    try:
        ...
        raise AppError("Failed to load context", "APP_CONTEXT_LOAD_ERROR",cause=e)
...
def publish_context() -> None:
    ...
    try:
        ...
        raise AppError("Failed to publish context", "APP_CONTEXT_PUBLISH_ERROR", cause=e)
