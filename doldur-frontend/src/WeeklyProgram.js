      ...
      >
        {data.type === "course" ? (
          ...
          <DontFillBlock
            ...
            onChangeDontFillColor={(color) =>
              this.handleChangeDontFillColor(data.startDate, color)
            }
            ...
            <div className={"program-row"}>
              ...
              <div className={"program-textfield-wrapper"}>
                <TextField
                  ...
                  onChange={(e) =>
                    this.handleScenarioChangeAbsolute(parseInt(e.target.value))
                  }
                />
              </div>
              <div className={"program-typo-wrapper"}>
                <Typography>{" of " + this.props.scenarios.length}</Typography>
              </div>
              <IconButton onClick={() => this.handleScenarioChange(1)}>
