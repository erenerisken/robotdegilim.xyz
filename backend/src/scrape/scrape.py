        ...
        with busy_idle(s3_client):
            ...
            for index,dept_code in enumerate(dept_codes,start=1):
                try:
                    ...
                    if dept_code not in dept_prefixes or dept_prefixes[dept_code] in app_constants.no_prefix_variants:
                    ...
                    raise RecoverError("Failed to process dept",{"dept_code":dept_code,"error":str(e)}) from None
            ...
            departments_noprefix_path = app_constants.data_dir / app_constants.departments_noprefix_json
